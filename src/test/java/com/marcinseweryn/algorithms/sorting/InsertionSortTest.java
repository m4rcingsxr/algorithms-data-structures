...
class InsertionSortTest {
    ...
    @CsvFileSource(delimiter = '|', resources = "resources/InsertionSort.csv", useHeadersInDisplayName = true)
    void insertionSortTest(@ConvertWith(ToIntegerArrayConverter.class) Integer... in) {
