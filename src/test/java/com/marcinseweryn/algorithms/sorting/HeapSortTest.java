...
class HeapSortTest {
    ...
    @CsvFileSource(delimiter = '|', resources = "resources/HeapSort.csv" , useHeadersInDisplayName = true)
    void heapSortTest(@ConvertWith(ToIntegerArrayConverter.class) Integer... in) {
