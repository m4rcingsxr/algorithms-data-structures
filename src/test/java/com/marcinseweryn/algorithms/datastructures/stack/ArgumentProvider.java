...
public class ArgumentProvider {
    ...
    private static Stream<Arguments> toStringTest() {
        return Stream.of(
                Arguments.arguments(new Integer[]{1, 2, 3, 4, 8},
                                    Arrays.toString(
                                            new Integer[]{1, 2, 3, 4, 8})
                ),
                Arguments.arguments(new Integer[]{2, 3, 4, 5},
                                    Arrays.toString(new Integer[]{2, 3, 4, 5})
                ),
                Arguments.arguments(new Integer[]{1, 2, 3},
    ...
    private static Stream<Arguments> popToEmptyTest() {
        return Stream.of(
                Arguments.arguments(new Integer[]{1, 2, 3, 4, 8},
                                    new Integer[]{8, 4, 3, 2, 1}
                ),
                Arguments.arguments(new Integer[]{2, 3, 4, 5},
                                    new Integer[]{5, 4, 3, 2}
                ),
                Arguments.arguments(new Integer[]{1, 2, 3}, new Integer[]{3,
                                                                          2,
                                                                          1}),
